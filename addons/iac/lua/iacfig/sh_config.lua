iac.Config.BadModules = {
    "gmcl__cv3_win32.dll",
    "gmcl__nyx_win32.dll",
    "gmcl_aaa_win32.dll",
    "gmcl_bsendpacket_win32.dll",
    "gmcl_chatclear_win32.dll",
    "gmcl_cvar3_win32.dll",
    "gmcl_dickwrap_win32.dll",
    "gmcl_enginepred_win32.dll",
    "gmcl_fhook_win32.dll",
    "gmcl_hi_win32.dll",
    "gmcl_mega_win32.dll",
    "gmcl_name_enabler_win32.dll",
    "gmcl_spreadthebutter_win32.dll",
    "gmsv_cvar3.dll",
    "gmsv_cvar3_win32.dll",
    "gmcl_cat_win32.dll",
    "gmcl_phack_win32.dll"
}

iac.Config.BadGlobals = {
    "hack",
    "cheat",
    "aimbot",
    "wallhack",
...
iac.Config.BadCVars = {
    ...
    "ahack_aimbot_active",
    "mapex_showadmins",
    "mapex_speedhack_speed",
    "mapex_dancin",
    "mapex_xray",
    "damnbot_esp_info",
    "damnbot_esp_box",
    "damnbot_misc_bunnyhop",
    "damnbot_aim_aimspot",
    "fap_esp_radar",
    "fap_bunnyhopspeed",
    "fap_checkforupdates",
    ...
    "traffichack_aimbot_randombones",
    "lenny_triggerbot",
    "lenny_aimsnap",
    "lenny_wh",
    "dead_esp"
